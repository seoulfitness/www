...
@Data
public class PhysicalSubjectDto {
    private int physicalSubjectId;               // 실기 교과목 아이디
    private String physicalSubjectName;          // 실기 교과목 이름
    private String physicalSubjectMemo;          // 실기 교과목 메모
