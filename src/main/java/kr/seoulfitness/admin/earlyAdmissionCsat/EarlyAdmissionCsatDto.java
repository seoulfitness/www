...
public class EarlyAdmissionCsatDto {
    ...
    private int acceptedCount;         // 모집 인원
    private int csatReflectedScore;    // 수능 반영 점수
    private int physicalReflectedScore; // 신체 반영 점수
    private int internalReflectedScore; // 내신 반영 점수
    private int interviewReflectedScore; // 면접 반영 점수
    private int totalReflectedScore;    // 총점 반영 점수
