                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">                
                                            ...
                                            <a class="btn btn-primary" href="/admin/internalSubSubjects/create">내신 세부 교과목 등록</a>
                                        </div>
                                        <%--// 검색 폼, 등록 버튼 --%>
                                            ...
                                            <nav aria-label="Page navigation" class="mt-4">
                                                <ul class="pagination justify-content-center">
                                                    ...
                                                    <c:if test="${pagination.currentPage > 1}">
                                                        <li class="page-item">
                                                            <a class="page-link" href="/admin/internalSubSubjects?page=${pagination.currentPage - 1}&keyword=${keyword}" aria-label="Previous">
                                                    ...
                                                    <c:forEach begin="${pagination.startPage}" end="${pagination.endPage}" var="page">
                                                        <li class="page-item ${page == pagination.currentPage ? 'active' : ''}">
                                                            <a class="page-link" href="/admin/internalSubSubjects?page=${page}&keyword=${keyword}">${page}</a>
                                                        </li>
                                                    </c:forEach>
                                                    ...
                                                    <c:if test="${pagination.currentPage < pagination.totalPages}">
                                                        <li class="page-item">
                                                            <a class="page-link" href="/admin/internalSubSubjects?page=${pagination.currentPage + 1}&keyword=${keyword}" aria-label="Next">
