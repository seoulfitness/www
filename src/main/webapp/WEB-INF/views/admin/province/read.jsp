                                            ...
                                            <table class="table table-hover">
                                                <tbody>
                                                    <tr class="border-top">
                                                        ...
                                                        <td class="align-middle col-10">${province.provinceName}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle col-10">${province.createdUserName} (${province.createdBy}, ${province.createdUserPhone})</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="align-middle col-2">수정일시</th>
                                                        <td class="align-middle col-10"><fmt:formatDate value="${province.updatedAt}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="align-middle col-2">수정한 사람</th>
                                                        <td class="align-middle col-10">${province.updatedUserName} (${province.updatedBy}, ${province.updatedUserPhone})</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="deleteForm" action="/admin/provinces/${province.provinceId}/delete" method="POST">
                        <%-- modal-header --%>
                        <div class="modal-header">
                            <h1 class="modal-title fs-5 text-danger" id="deleteModalModalLabel">
                                <strong>시/도 삭제</strong>
                            </h1>
