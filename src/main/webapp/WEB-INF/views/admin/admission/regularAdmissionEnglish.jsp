...
<c:if test="${admission.regularAdmission == 'Y'}">
    <h5 class="mb-2 text-primary text-sm">정시 영어 정보</h5>
    <c:choose>
        <%-- 정시 영어 정보 없음 --%>
        ...
        <c:otherwise>
            ...
            <div class="mb-5">
                ...
                <a href="/admin/regularAdmissionEnglish/${regularAdmissionEnglish.regularAdmissionEnglishId}/update" class="btn btn-outline-warning">수시 입시 영어 정보 수정</a>
            </div>                                               
        </c:otherwise>
        <%--// 정시 영어 정보 있음 --%>
    </c:choose>
