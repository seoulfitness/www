            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="updateForm" action="/admin/admissions/${admission.admissionId}/update" method="post">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">                                            
                                            <div class="mb-3">
                                                <label class="small mb-1" for="admissionYear">연도<span class="text-danger small">*</span></label>
