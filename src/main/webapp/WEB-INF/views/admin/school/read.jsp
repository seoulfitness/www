                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer">
                                            <a href="/admin/schools" class="btn btn-primary">대학교 목록</a>
                                            <a href="/admin/schools/${school.schoolId}/update" class="btn btn-outline-warning">대학교 수정</a>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="deleteForm" action="/admin/schools/${school.schoolId}/delete" method="POST">
                        <%-- modal-header --%>
