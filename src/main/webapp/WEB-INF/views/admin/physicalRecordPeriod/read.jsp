                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer">
                                        <a href="/admin/physicalRecordPeriods" class="btn btn-primary">실기 기록 기간 목록</a>
                                        <a href="/admin/physicalRecordPeriods/${physicalRecordPeriod.physicalRecordPeriodId}/update" class="btn btn-outline-warning">실기 기록 기간 수정</a>
                                        <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">실기 기록 기간 삭제</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="deleteForm" action="/admin/physicalRecordPeriods/${physicalRecordPeriod.physicalRecordPeriodId}/delete" method="POST">
                        <%-- modal-header --%>
                        <div class="modal-header">
                            <h1 class="modal-title fs-5 text-danger" id="deleteModalModalLabel">
                                <strong>실기 기록 기간 삭제</strong>
                            </h1>
