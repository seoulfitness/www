            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="updateForm" action="/admin/csatRecordPeriods/${csatRecordPeriod.csatRecordPeriodId}/update" method="post">
                                    <input type="hidden" name="csatRecordPeriodId" value="${csatRecordPeriod.csatRecordPeriodId}" />
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            수능 기록 등록 기간 수정 (<span class="text-danger small">*</span> 표시는 필수 입력 항목입니다.)
                                        </div>
                                        <div class="card-body">                                     
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="memo" id="memo" placeholder="메모를 입력하세요." value="${not empty csatRecordPeriod.memo ? csatRecordPeriod.memo : ''}"></textarea>
                                            </div>                                                                                 
                                        </div>
                                        <div class="card-footer">
                                            <button class="btn btn-primary" type="submit">수능 기록 기간 수정</button>
                                            <a href="/admin/csatRecordPeriods/${csatRecordPeriod.csatRecordPeriodId}" class="btn btn-outline-danger">수정 취소</a>
                                        </div>  
                                    </div>
                                </form>
                            </div>
