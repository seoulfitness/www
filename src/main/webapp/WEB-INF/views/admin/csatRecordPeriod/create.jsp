            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="createForm" action="/admin/csatRecordPeriods/create" method="post">
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            수능 기록 기간 등록 (<span class="text-danger small">*</span> 표시는 필수 입력 항목입니다.)
                                        </div>
                                        <div class="card-body">                                        
                                            <div class="mb-3">
                                        ...
                                        <div class="card-footer">
                                            <button class="btn btn-primary" type="submit">수능 기록 기간 등록</button>
                                            <a href="/admin/csatRecordPeriods" class="btn btn-outline-danger">등록 취소</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
