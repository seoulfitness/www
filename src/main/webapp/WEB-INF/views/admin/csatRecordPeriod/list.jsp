                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">                
                                            ...
                                            <a class="btn btn-primary" href="/admin/csatRecordPeriods/create">수능 기록 기간 등록</a>
                                        </div>
                                        <%--// 검색 폼, 등록 버튼 --%>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${csatRecordPeriods}" var="csatRecordPeriod">
                                                        <tr>
                                                            <td class="align-middle text-center">${csatRecordPeriod.title}</td>
                                                            <td class="align-middle text-center"><fmt:formatDate value="${csatRecordPeriod.startDate}" pattern="yyyy-MM-dd"/></td>
                                                            ...
                                                            <td class="align-middle text-center">
                                                                <a href="/admin/csatRecordPeriods/${csatRecordPeriod.csatRecordPeriodId}" class="btn btn-outline-primary btn-sm">보기</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
