                                ...
                                <form id="updateForm" action="/admin/earlyAdmissionHistory/update?admissionId=${admissionId}" method="post" enctype="multipart/form-data">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-footer">
                                            <button class="btn btn-primary" type="submit">수시 입시 한국사 정보 수정</button>
                                            <a href="/admin/admissions/${earlyAdmissionHistory.admissionId}#earlyAdmissionHistory" class="btn btn-outline-danger">취소</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
