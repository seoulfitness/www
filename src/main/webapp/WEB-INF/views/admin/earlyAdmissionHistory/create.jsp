            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="createForm" action="/admin/earlyAdmissionHistory/create?admissionId=${admissionId}" method="post" enctype="multipart/form-data">
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            ${admission.admissionYear}년 ${admission.admissionType}군 ${admission.schoolName} ${admission.departmentName} 수시 입시 한국사 정보 등록 (<span class="text-danger small">*</span> 표시는 필수 입력 항목입니다.)
                                        </div>
                                        <div class="card-body">
                                            <div class="mb-3">
                                                <label class="small mb-1" for="subject20ReflectedGrade1">한국사 등급 1 점수 <span class="text-danger">(감점일 경우 -를 붙여주세요)</span></label>
                                                <input class="form-control" id="subject20ReflectedGrade1" name="subject20ReflectedGrade1" type="number" value="${empty earlyAdmissionHistory.subject20ReflectedGrade2 ? '0.000' : earlyAdmissionHistory.subject20ReflectedGrade2}" />
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="card-footer">
                                            <button class="btn btn-primary" type="submit">수시 입시 한국사 정보 등록</button>
                                            <a href="/admin/admissions/${admissionId}#earlyAdmissionHistory" class="btn btn-outline-danger">취소</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
