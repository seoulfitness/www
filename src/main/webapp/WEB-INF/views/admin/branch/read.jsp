                                    ...
                                    <c:forEach var="branchManagerInBranch" items="${branchManagersInBranch}">
                                        <div class="col-lg-6">
                                            <div class="card mb-4">
                                                <div class="card-header">
                                                    지점 관리자
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addManagerModal">관리자 추가</button>
                                                </div>
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <%-- 지점 관리자 목록 --%>                                                    
                                                ...
                                                <div class="card-footer">
                                                    <a href="/admin/branches" class="btn btn-primary">지점 목록</a>
                                                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteManagerModal">관리자 삭제</button>
                                                </div>
                                            </div>
                                        </div>
                                    </c:forEach>                                    
        ...
        <div class="modal fade" id="addManagerModal" tabindex="-1" aria-labelledby="addManagerModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="addManagerForm" action="/branches/${branch.branchId}/addManager" method="POST">
                        <%-- modal-header --%>
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="userId" name="userId">
                                    <c:if test="${not empty branchManagersNotInBranch}">
                                        <c:forEach var="branchManager" items="${branchManagersNotInBranch}">
                                            <option value="${branchManager.userId}">${branchManager.userName} (${branchManager.userPhone}${not empty branchManager.userEmail ? ' / ' + branchManager.userEmail : '' })</option>
                                        </c:forEach>
                                    </c:if>
                                </select>
                            </div>
