            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="updateForm" action="/admin/criterias/${criteria.criteriaId}/update" method="post">
                                    <input type="hidden" name="criteriaId" value="${criteria.criteriaId}" />
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            입시 요강 수정 (<span class="text-danger small">*</span> 표시는 필수 입력 항목입니다.)
                                        </div>
                                        <div class="card-body">                                            
                                            <div class="mb-3">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="/admin/criterias" class="btn btn-outline-danger">수정 취소</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
