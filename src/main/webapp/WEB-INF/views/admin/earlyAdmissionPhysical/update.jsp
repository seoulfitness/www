                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select class="form-control" id="subject1Id" name="subject1Id">
                                                            <c:forEach var="physicalSubject" items="${physicalSubjects}">
                                                                <option value="${physicalSubject.physicalSubjectId}" ${earlyAdmissionPhysical.subject1 == physicalSubject.physicalSubjectId ? 'selected' : ''}>${physicalSubject.physicalSubjectName}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
