                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer">
                                        <a href="/admin/internalSubjects" class="btn btn-primary">내신 교과목 목록</a>
                                        <a href="/admin/internalSubjects/${internalSubject.internalSubjectId}/update" class="btn btn-outline-warning">내신 교과목 수정</a>
                                        <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">내신 교과목 삭제</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="deleteForm" action="/admin/internalSubjects/${internalSubject.internalSubjectId}/delete" method="POST">
                        <%-- modal-header --%>
                        <div class="modal-header">
                            <h1 class="modal-title fs-5 text-danger" id="deleteModalModalLabel">
                                <strong>내신 교과목 삭제</strong>
                            </h1>
