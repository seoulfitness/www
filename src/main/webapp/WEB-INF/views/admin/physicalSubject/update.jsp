            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="updateForm" action="/admin/physicalSubjects/${physicalSubject.physicalSubjectId}/update" method="post">
                                    <input type="hidden" name="physicalSubjectId" value="${physicalSubject.physicalSubjectId}" />
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            실기 교과목 수정 (<span class="text-danger small">*</span> 표시는 필수 입력 항목입니다.)
                                        </div>
                                        <div class="card-body">                                        
                                            <div class="mb-3">
                                        ...
                                        <div class="card-footer">
                                            <button class="btn btn-primary" type="submit">실기 교과목 수정</button>
                                            <a href="/admin/physicalSubjects" class="btn btn-outline-danger">수정 취소</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
