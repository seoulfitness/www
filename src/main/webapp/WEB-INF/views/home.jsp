        ...
        <div id="layoutDefault">
            <div id="layoutDefault_content">
                <main>
                    ...
                    <section class="bg-white pt-10 pb-5" id="explore">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach items="${admissions}" var="admission" varStatus="status">
                                                    <tr>
                                                        <td class="text-center">${admission.admissionType}군</td>
                                                        <td>
                                                            <c:choose>
                                                        ...
                                                        <td>
                                                            <c:choose>
                                                                <c:when test="${not empty admission.earlyAdmission && admission.earlyAdmission == 'Y'}">
                                                                    <span class="btn btn-success btn-sm">진행</span>
                                                                </c:when>
                                                                <c:otherwise>
                                                        ...
                                                        <td>
                                                            <c:if test="${not empty admission.schoolUrl}">
                                                                <a href="${admission.schoolUrl}" target="_blank"><i data-feather="external-link"></i></a>
                                                            </c:if>
                                                        </td>
                                                        <td>
                                                            <c:if test="${not empty admission.admissionInfoUrl}">
                                                                <a href="${admission.admissionInfoUrl}" target="_blank"><i data-feather="external-link"></i></a>
                                                            </c:if>
                                                        </td>
                                                        <td>${admission.schoolPhone}</td>                                                                
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
