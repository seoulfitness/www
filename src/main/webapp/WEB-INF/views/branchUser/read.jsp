                            ...
                            <div class="col-lg-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-footer">
                                        <a href="/admin/branch-users" class="btn btn-primary">지점 회원 목록</a>
                                        <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">지점 회원 삭제</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="deleteForm" action="/admin/branch-users/${user.userId}/delete" method="POST">
                        <%-- modal-header --%>
                        <div class="modal-header">
                            <h1 class="modal-title fs-5 text-danger" id="deleteModalModalLabel">
                                <strong>지점 회원 삭제</strong>
                            </h1>
