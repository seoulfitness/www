...
CREATE TABLE IF NOT EXISTS USERS (
    ...
    PROVINCE_ID INT DEFAULT '0' COMMENT '시/도',
    DISTRICT_ID INT DEFAULT '0' COMMENT '구/군',
    SCHOOL_ID INT DEFAULT '0' COMMENT '학교',
    GRADE INT DEFAULT '0' COMMENT '학년',
    STUDENT_PARENT INT DEFAULT '0' COMMENT '학생/학부모',
